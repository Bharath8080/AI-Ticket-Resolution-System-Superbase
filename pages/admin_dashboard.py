...
if not st.session_state.authenticated:
    ...
    st.info("Please log in from the sidebar to access management features.")
    st.stop()
else:
    # Sidebar Filters
    ...
    if tickets_df.empty:
        ...
        # Filter out None from severity options before passing to multiselect
